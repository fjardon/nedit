static const char CVSID[] = "$Id: highlightData.c,v 1.27.2.4 2002/03/21 00:19:54 amai Exp $";
/*******************************************************************************
*									       *
